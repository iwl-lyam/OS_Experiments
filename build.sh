...
nasm "boot.asm" -f bin -g -F dwarf -o "boot.bin"
...
echo "kernel link"
i686-elf-ld -o "full_kernel.o" -Ttext 0x1000 "kernel_entry.o"  "idt.o" "pic.o" "io.o" "isr.o" "isr_asm.o" "idt_asm.o" "kernel.o" --oformat elf32
i686-elf-ld -o "OS.o" "boot.bin" "full_kernel.o"
